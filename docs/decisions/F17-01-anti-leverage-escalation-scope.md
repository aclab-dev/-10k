...
1. **Las pérdidas del sistema son de la cuenta, no del par.** La tabla de
   ...
   pérdida que se intentaría "recuperar" es de ese capital: perder en BTCUSDT y subir el leverage en SOLUSDT es exactamente
   el patrón que la regla prohíbe. Con alcance por símbolo, rotar de par
...
- Tras un trade perdedor, ningún símbolo puede abrir con más leverage que el
  de ese trade hasta que cierre un trade no perdedor.
