...
| 6 | Pérdida diaria máx. 10% | ✅ | [`check_daily_drawdown`](../backend/risk_engine/checks.py#L106) (BLOCK), wired en `engine.py:128`. Test: `tests/unit/test_risk_engine_exhaustive.py`. |
| 7 | Pérdida total máx. 50% | ✅ | [`check_total_drawdown`](../backend/risk_engine/checks.py#L137) (BLOCK), wired en `engine.py:129`. Test: `tests/unit/test_risk_engine_exhaustive.py`. |
...
| # | Regla | Estado | Evidencia |
|---|---|---|---|
| 10 | Stop loss obligatorio | ✅ | [`check_sl_required`](../backend/risk_engine/checks.py#L59) (BLOCK) + defensa redundante dentro de [`check_liquidation_safety`](../backend/risk_engine/checks.py#L242). Test: `tests/unit/test_risk_engine_exhaustive.py`. |
| 11 | Take profit o plan de salida obligatorio | ✅ | [`check_tp_or_exit_plan`](../backend/risk_engine/checks.py#L74) (BLOCK). Test: `tests/unit/test_risk_engine_exhaustive.py`. |
...
| # | Regla | Estado | Evidencia |
|---|---|---|---|
| 26 | No martingala | ✅ | Boot: [`RiskConfig.no_martingale`](../backend/core/config.py#L145). Runtime: [`check_anti_martingala`](../backend/risk_engine/checks.py#L398) (BLOCK), wired en `engine.py:131`. Test: `tests/unit/test_config.py:247`, `tests/unit/test_risk_engine_anti_martingala.py:23-172`. |
| 27 | No promediar pérdidas | ✅ | [`check_anti_averaging`](../backend/risk_engine/checks.py#L489) (BLOCK), wired en `engine.py:132`. Test: `tests/unit/test_risk_engine_anti_martingala.py:182-228`. |
