...
| 6 | Pérdida diaria máx. 10% | ✅ | [`check_daily_drawdown`](../backend/risk_engine/checks.py#L105) (BLOCK), wired en `engine.py:122`. Test: `tests/unit/test_risk_engine_exhaustive.py`. |
| 7 | Pérdida total máx. 50% | ✅ | [`check_total_drawdown`](../backend/risk_engine/checks.py#L136) (BLOCK), wired en `engine.py:123`. Test: `tests/unit/test_risk_engine_exhaustive.py`. |
...
| # | Regla | Estado | Evidencia |
|---|---|---|---|
| 26 | No martingala | ✅ | Boot: [`RiskConfig.no_martingale`](../backend/core/config.py#L145). Runtime: [`check_anti_martingala`](../backend/risk_engine/checks.py#L397) (BLOCK), wired en `engine.py:125`. Test: `tests/unit/test_config.py:247`, `tests/unit/test_risk_engine_anti_martingala.py:23-172`. |
| 27 | No promediar pérdidas | ✅ | [`check_anti_averaging`](../backend/risk_engine/checks.py#L488) (BLOCK), wired en `engine.py:126`. Test: `tests/unit/test_risk_engine_anti_martingala.py:182-228`. |
