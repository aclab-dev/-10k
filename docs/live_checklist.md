...
| 2 | Leverage máx. 10x PAPER | ✅ | Boot: [`LeverageConfig`](../backend/core/config.py#L165) (`max_leverage_paper>10` rechaza, línea 174). Runtime: [`leverage_cap_for_env`](../backend/risk_engine/checks.py#L42) + [`check_leverage_cap`](../backend/risk_engine/checks.py#L188). Test: `tests/unit/test_config.py:232`. |
