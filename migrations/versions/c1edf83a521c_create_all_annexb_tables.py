...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("balance_usdt", sa.Numeric(20, 8), nullable=False),
        sa.Column("equity_usdt", sa.Numeric(20, 8), nullable=False),
        sa.Column("margin_used_usdt", sa.Numeric(20, 8), nullable=False, server_default="0"),
        sa.Column("unrealized_pnl", sa.Numeric(20, 8), nullable=False, server_default="0"),
        sa.Column("realized_pnl_session", sa.Numeric(20, 8), nullable=False, server_default="0"),
    ...
    op.create_index("ix_feature_packages_hash", "feature_packages", ["hash"], unique=True)
    ...
    op.create_table(
        ...
        sa.Column("margin_usdt", sa.Numeric(20, 8), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("original_margin", sa.Numeric(20, 8), nullable=True),
        sa.Column("original_leverage", sa.Integer(), nullable=True),
        sa.Column("adjusted_margin", sa.Numeric(20, 8), nullable=True),
        sa.Column("adjusted_leverage", sa.Integer(), nullable=True),
        sa.Column("reasons", JSONB(), nullable=True),
        sa.Column("daily_loss_at_check", sa.Numeric(20, 8), nullable=True),
        sa.Column("total_loss_at_check", sa.Numeric(20, 8), nullable=True),
    )
    ...
    op.create_table(
        ...
        sa.Column("funding_paid", sa.Numeric(20, 8), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("old_value", sa.Numeric(20, 8), nullable=True),
        sa.Column("new_value", sa.Numeric(20, 8), nullable=True),
        sa.Column("reason", sa.Text(), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("avg_pnl", sa.Numeric(20, 8), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("total_funding", sa.Numeric(20, 8), nullable=True),
        sa.Column("sharpe_ratio", sa.Float(), nullable=True),
        sa.Column("max_drawdown", sa.Float(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("estimated_cost_usd", sa.Numeric(20, 8), nullable=True),
    )
