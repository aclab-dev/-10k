...
_REGIME_MULTIPLIERS: Final[dict[PrimaryRegime, float]] = {
    PrimaryRegime.TRENDING: 1.0,  # dirección definida → vol cap es suficiente
    PrimaryRegime.RANGING: 0.8,  # sin dirección clara → leve reducción
    PrimaryRegime.HIGH_VOLATILITY: 0.7,  # régimen volátil sobre vol assessment → doble precaución
    PrimaryRegime.LOW_VOLATILITY: 1.0,  # calmo → mantener vol cap
    PrimaryRegime.BREAKOUT: 0.7,  # spikes impredecibles, falsas rupturas frecuentes
    PrimaryRegime.UNCLEAR: 0.5,  # sin señal definida → postura más conservadora
}
