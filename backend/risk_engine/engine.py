...
def validate(
    ...
    Args:
        ...
        funding_rate: funding rate por intervalo del snapshot del ciclo (None = desconocido).
            Fase BLOCK: usado por check_funding_gate; con block_if_funding_unknown=True,
            omitirlo bloquea el trade (fail-closed).
