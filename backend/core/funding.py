"""Cálculo de funding para futuros perpetuos.

Módulo neutral de dominio: puede ser usado por el PaperAdapter,
el engine de backtesting, el live trading engine y el risk manager.
